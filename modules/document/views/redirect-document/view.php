...
$this->title = 'For-Redirect Document Details';
if ($_GET['type'] == 'IC'){
$this->params['breadcrumbs'][] = ['label' => 'For-Redirect Document', 'url' => ['index?type=IC']];
}
if ($_GET['type'] == 'I'){
$this->params['breadcrumbs'][] = ['label' => 'For-Redirect Document', 'url' => ['index?type=I']];
}
if ($_GET['type'] == 'O'){
$this->params['breadcrumbs'][] = ['label' => 'For-Redirect Document', 'url' => ['index?type=O']];
}
...
<div class="box box-primary">
    ...
    <hr style="margin-top: -5px !important; border-bottom: 2px solid #fbc02d;"/>
      ...
      <div class="form-group required">
        ...
        <?= $form->field($redirect, 'individual')->widget(Select2::classname(),[
        ...
        <?= $form->field($redirect, 'remarks')->textInput(['autofocus' => true])->textarea(['rows' => 6]) ?>

        <center><?= Html::submitButton('Redirect Document', 
                    [
