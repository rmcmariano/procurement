...
class Division extends \yii\db\ActiveRecord
{
    ...
    {
        return Yii::$app->get('human_resources');
    }
    ...
    {
        return [
            [['agency_id', 'division_code', 'division_name', 'division_address', 'division_contact', 'division_email', 'division_head_id', 'division_head', 'division_field', 'division_status'], 'required'],
            [['agency_id', 'division_head_id', 'division_field', 'division_status'], 'integer'],
