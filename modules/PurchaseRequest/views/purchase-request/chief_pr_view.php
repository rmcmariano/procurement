...
<div class="purchase-request-chief">
      ...
      <table class="table table-responsive" style="text-transform: uppercase">
        ...
        <tr>
          ...
          <td colspan="2"><span style="font-size: 17px; font-weight: bold">
              <!-- <= ($model->pr_type_id == 3 && $model->charge_to == 0 ? 'GAA' : ($model->pr_type_id == 1 && $model->charge_to == 0 ? 'SDO' : $model->chargedisplay->project_title)) ?></span> -->
      ...
      <?= GridView::widget([
        ...
        'columns' => [
          ...
          [
            ...
            'header' => 'ACTIONS',
            'headerOptions' => ['style' => 'color:#337ab7'],
            'template' => '{evaluate} {status} {cancel}',
            'options' => ['style' => 'width:20%'],
            'buttons' => [
...
$this->registerJs(
  <<<JS
            ...
            .then((willDisapprove) => {
                if (willDisapprove != null) {
                    swal("Success.", {
                        ...
                        $.ajax({
                            url: "/purchase-request/chief-prdisapproved",
                            type: 'post',
                            data: {
        ...
        $('.approvedBtn').on('click', function() {
          var idToSubmit = $(this).val(); // Storing the value of the clicked button
          ...
          swal({
              ...
              if (willSubmit) {
                  swal("Approved", {
                      ...
                      $.ajax({
                          url: "/procurement/web/PurchaseRequest/purchase-request/chief-prapproved",
                          type: "get",
                          data: {
                              rtn: idToSubmit // Using the stored value here
                          },
