    ...
    <div class="box-header with-border">
      ...
      <table class="table table-responsive">
        ...
        <tr>
          ...
          <td> <span style="font-size: 15px; font-weight: bold;"><?= $model->mode_pr_id == '' || NULL ? false : true ?> </span> </td>
        </tr>
        <tr>
            ...
            [
              ...
              'buttons' => [
                'status' => function ($url, $model, $key) {
                  return Html::a('<span class="glyphicon glyphicon-eye-file"></span> Logs', ['purchase-request/purchaserequest-itemlogs', 'id' => $model->id],  ['class' => 'btn btn-info btn-sm']);
                },
              ],
            ],
          ]
