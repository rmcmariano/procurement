                ...
                [
                    ...
                    'buttons' => [
                        'status' => function ($url, $model, $key) {
                            return Html::button('<span class="glyphicon glyphicon-file"></span>Logs', ['value' => Url::to(['purchase-request/purchaserequest-itemlogs', 'id' => $model->id]), 'class' => 'btn btn-info btn-sm modalStatusbtn']);
                        },
                        ...
                        'view' => function ($url, $model, $key) {
                            return Html::a('<span class="glyphicon glyphicon-eye-open"></span> View', ['purchase-request/sdo-view', 'id' => $model->pr_id],  ['class' => 'btn btn-success btn-sm']);
                        },
                    ],
                ],
            ]
