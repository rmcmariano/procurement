...
<div class="purchase-order">
	...
	<table style="border-collapse: collapse; border: 1px solid;  font-family: Arial, Helvetica, sans-serif; width: 100%">
		<tr>
			<td style="width: 65%; border-right: 1px solid; font-size: small; text-align: center"> <strong>BUDGET UTILIZATION REQUEST AND STATUS</strong></td>
	...
	<table style="border-collapse: collapse; border: 1px solid;  font-family: Arial, Helvetica, sans-serif;width: 100%; text-align:center; font-size: small ">
		...
		'<tr>
				...
				<td style="width: 35%; border-right: 1px solid;  font-size: small;padding-top: 1%; padding-left: 1%; text-align:left">PO/WO No.: &nbsp;&nbsp; <strong>' . $poNo . '</strong></td>
