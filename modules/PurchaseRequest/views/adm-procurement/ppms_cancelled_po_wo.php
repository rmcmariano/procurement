            ...
            [
              ...
              'buttons' => [
                ...
                'conforme' => function ($url, $model) {
                  return Html::button('<span class="glyphicon glyphicon-ok "></span> For Conforme',  ['value' => $model['id'], 'class' => 'btn btn-warning btn-sm conformBtn']);
                },
                'cancel' => function ($url, $model) {
                  // var_dump($model);die;
                  return Html::button('<span class="glyphicon glyphicon-remove "></span>',  ['class' => 'btn btn-danger btn-sm cancel', 'value' => $model->id,  'title' => 'Cancel']);
                },
              ],
              'visibleButtons' => [
