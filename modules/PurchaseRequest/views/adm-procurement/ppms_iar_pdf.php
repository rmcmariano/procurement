...
<div class="purchase-order">
	<div style="text-align:center; font-size: smaller">
		<h3><strong>INSPECTION AND ACCEPTANCE REPORT</strong></h3>
	</div>
	...
	<table style="border-collapse: collapse; border: 1px solid;  font-family: Arial, Helvetica, sans-serif; width: 100%">
		<tr>
			<td style="width: 65%; border-right: 1px solid; font-size: small"> Supplier: &nbsp;&nbsp;&nbsp; <?= $bidding->supplierdisplay->supplier_name ?></td>
			<td style="width: 35%; font-size: small;"> IAR No.: <?= $iarModel->iar_number ?> </td>
		</tr>
		<tr>
			<td style="width: 65%; font-size: small; border-right: 1px solid"> P.O./W.O. No.: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <?= $purchaseOrder->po_no ?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Date: <?= Yii::$app->formatter->asDatetime(strtotime($purchaseOrder->po_date_created), 'php:M d, Y') ?> </td>
			<td style="width: 35%; font-size: small;"> Date: <?= Yii::$app->formatter->asDatetime(strtotime($iarModel->iar_date), 'php:M d, Y') ?> </td>
		</tr>
		<tr>
			<td style="width: 65%; border-right: 1px solid;  font-size: small;"> Requisitioning Office/Dept.: <?= $purchaserequest->sectiondisplay->section_code ?></td>
			<td style="width: 35%; font-size: small;"> Invoice No.: <?= $iarModel->sales_invoice_number ?> </td>
		</tr>
		<tr>
			<td style="width: 65%; border-right: 1px solid;  font-size: small;"> Responsibility Center Code: <?= $bidding->supplierdisplay->tin_no ?></td>
	...
	<table style="border-collapse: collapse; border: 1px solid;  font-family: Arial, Helvetica, sans-serif;width: 100%; text-align:center; font-size: small ">
		<tr>
			<td style="width: 15%; border: 1px solid;  font-size: small;"><strong>Stock/<br>Property<br> No.</strong></td>
			<td style="width: 50%; border: 1px solid; font-size: small;"><strong> Item Description </strong></td>
			<td style="width: 17.5%; border:1px solid; font-size: small;"><strong> Unit </strong></td>
