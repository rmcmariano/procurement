...
<div class="modal-header ics">
  <h5 class="modal-title" id="modal-bulletin-label"> Create PAR
...
<div class="icsForm">
  ...
  <div class="row">
    <div class="col-md-6 col-sm-12">
      <?= $form->field($parModel, 'par_no')->label('PAR Number:') ?>
    </div>
    <div class="col-md-6 col-sm-12">
      <?= $form->field($parModel, 'date_acquire')->widget(
  ...
  <div class="row">
    <div class="col-md-6 col-sm-12">
      <?= $form->field($parModel, 'account_code')->label('Account Code:') ?>
    </div>
    <div class="col-md-6 col-sm-12">
      <?= $form->field($parModel, 'estimated_useful_life')->label('Estimated Useful Life:') ?>
    </div>
  </div>

  <div class="row">
    <div class="col-md-6 col-sm-12">
      <?= $form->field($parModel, 'equipment_location')->label('Equipment Location:') ?>
    </div>
  </div>

  <div class="row">
    <div class="col-md-6 col-sm-12">
      <?= $form->field($parModel, 'received_from')->dropDownList(
        Profile::filterAdmin(),
        ['id' => 'type', 'prompt' => 'Select',]
      ) ?>
    </div>
    <div class="col-md-6 col-sm-12">
      <?= $form->field($parModel, 'received_by')->dropDownList(
        Profile::filterAdmin(),
        ['id' => 'type', 'prompt' => 'Select',]
      ) ?>
    </div>
