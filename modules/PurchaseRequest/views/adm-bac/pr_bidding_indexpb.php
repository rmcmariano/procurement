...
<div class="bidding-list-index">
    ...
    <div class="panel panel-default">
        <div style="padding: 20px">
          ...
          <?= Html::button('<span class="glyphicon glyphicon-print"></span>  Print Abstract', ['value' => Url::to(['bac-signatories/createsignatories', 'id' => $_GET['id']]),  'class' => 'btn btn-default modalSignatoriesbtn']); ?>
              <p> &nbsp;
                        ...
                        [
                            ...
                            'buttons' => [
                                'non-comply' => function ($url, $model, $key) {
                                    ...
                                    $enable = Html::button('<span class="glyphicon glyphicon-remove"></span> Non-Comply', ['value' => Url::to(['bidding/bac-biddingnoncomply', 'id' => $model->id,]),  'class' => 'btn btn-danger modalNoncomplybtn']);
                                    $disable =  Html::button('<span class="glyphicon glyphicon-remove"></span> Non-Comply', ['value' => Url::to(['bidding/bac-biddingnoncomply', 'id' => $model->id,]),  'class' => 'btn btn-danger modalNoncomplybtn', 'disabled' => true]);
                                ...
                                'comply' => function ($url, $model, $key) {
                                    ...
                                    $enable = Html::button('<span class="glyphicon glyphicon-check"></span> Comply', ['value' => Url::to(['bidding/bac-biddingcomply-modal', 'id' => $model->id]), 'class' => 'btn btn-success modalComplybtn']);
                                    $disable = Html::button('<span class="glyphicon glyphicon-check"></span> Comply', ['value' => Url::to(['bidding/bac-biddingcomply-modal', 'id' => $model->id]), 'class' => 'btn btn-success modalComplybtn', 'disabled' => true]);
