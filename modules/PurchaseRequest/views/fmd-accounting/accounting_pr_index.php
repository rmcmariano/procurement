...
<div>
    <?= Nav::widget([
        ...
        'items' => [
            ...
            [
                'label' => 'LIST OF PR',
                'url' => ['purchase-request/accounting-request-index', 'id' => $model->id],
                'options' => ['class' => 'nav-tab'],
                'active' => true,
            ],
            [
                'label' => 'LIST OF ITEMS',
                'url' => ['purchase-request/accounting-request-items', 'id' => $model->id],
                'options' => ['class' => 'nav-tab'],
            ],
        ],
    ]) ?>
...
<div class="accounting-request-index">
    <div class="box box-primary">
        <div class="box-header with-border">
            ...
            <p>
                <center>
                    <?= Html::a('<span class="glyphicon glyphicon-download-alt"></span> Generate PR Report', ['generate-report/accounting-pr-report', 'id' => $model->id,], ['class' => 'btn btn-warning']) . ' '; ?>
                </center>
            </p>
                ...
                'columns' => [
                    ...
                    [
                        ...
                        'detail' => function ($model, $key, $index, $column) {
                            ...
                            return Yii::$app->controller->renderPartial('/fmd-accounting/accounting_pr_items_expand', [
                    ...
                    [
                        ...
                        'buttons' => [
                            'view' => function ($url, $model, $key) {
                                return Html::a('<span class="glyphicon glyphicon-eye-open"></span>', ['purchase-request/accounting-prview', 'id' => $model->id], ['title' => 'View']);
                            },
