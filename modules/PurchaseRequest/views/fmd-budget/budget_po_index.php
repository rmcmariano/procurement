...
<div>
  <?= Nav::widget([
    ...
    'items' => [
      ...
      [
        'label' => 'PR DETAILS',
        'url' => ['purchase-request/budget-prview', 'id' => $modelPurchaserequest->id],
        'options' => ['class' => 'nav-tab'],
      ],
      [
        'label' => 'BUDGET MONITORING',
        'url' => ['purchase-request/pr-budgetmonitoring', 'id' => $modelPurchaserequest->id],
        'options' => ['class' => 'nav-tab'],
      ],
      [
        'label' => 'PURCHASE ORDER / WORKING ORDER',
        'url' => ['purchase-order/powo-budgetview', 'id' => $modelPurchaserequest->id],
        'options' => ['class' => 'nav-tab'],
        'active' => true,
      ],
    ],
