...
<div>
    <?= Nav::widget([
        ...
        'items' => [
            [
                'label' => 'LIST OF PR',
                'url' => ['purchase-request/budget-pending-request-index'],
                'options' => ['class' => 'nav-tab'],
                'active' => true,
            ],
            [
                'label' => 'LIST OF ITEMS',
                'url' => ['purchase-request/budget-pending-request-items'],
                'options' => ['class' => 'nav-tab'],
            ],
        ],
    ]) ?>
...
<div class="purchase-request-index">
    <div class="box box-primary">
        <div class="box-header with-border">
            ...
            <p>
                <center>
                    <?= Html::a('<span class="glyphicon glyphicon-download-alt"></span> Generate PR Report', ['generate-report/budget-pr-report', 'id' => $model->id,], ['class' => 'btn btn-warning']) . ' '; ?>
                </center>
            </p>
            ...
            <?= GridView::widget([
                ...
                'columns' => [
                    ...
                    [
                        ...
                        'filterInputOptions' => ['placeholder' => '- Type of PR -'],
                        'editableOptions' => function ($model, $key, $index, $widget) {
                            $modePr = ArrayHelper::map(PrType::find()->orderBy('type_name')->asArray()->all(), 'id', 'type_name');
                            $model->pr_type_id = ($model->pr_type_id === null) ? '<span style="color: red;">Select Type of PR</span>' : $model->pr_type_id;
