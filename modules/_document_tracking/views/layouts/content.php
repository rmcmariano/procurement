...
<footer class="main-footer">
    ...
    <strong><a href="https://itdi.gov.ph">DOST - Industrial Technology Development Institute</a>.</strong>
</footer>
...
<aside class="control-sidebar control-sidebar-dark">
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane active" id="control-sidebar-home-tab">
            <h3 class="control-sidebar-heading">ITDI APPLICATIONS</h3>
            <ul class='control-sidebar-menu'>
                ...
                <li>
                    <a href="<?= Url::toRoute(['/document_tracking/documents/index?type=IC'], $schema = true) ?>">
